# Homebrew
alias brewc='brew prune; and brew cleanup'
alias brewC='brew prune; and brew cleanup -s'
...
alias caskU='brew cask upgrade --greedy'
alias caskx='brew cask uninstall'
alias caskX='brew cask zap'
